...
**b站演示视频**：https://www.bilibili.com/video/BV1b2wRz4EPF?vd_source=1c0a8b223dbb336c5a045e1363e59448
...
左侧固定目录导航，点击可快速跳转各章节。正文内嵌渲染的真值表（带框线 HTML 表格）和 KaTeX 数学公式，系统化呈现每条推理规则的形式定义与使用示例。
